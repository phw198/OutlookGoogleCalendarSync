...
namespace OutlookGoogleCalendarSync.Outlook {
    class OutlookGraph : Interface {
        private static readonly ILog log = LogManager.GetLogger(typeof(OutlookGraph));
        ...
        private Dictionary<String, OutlookCalendarListEntry> calendarFolders = new();
        ...
        public void Connect() {
            try {
                ...
                // Get the Calendars
                //useOutlookCalendar = //where to work out the default?

                /* This will infinite loop!*/
                //if (Outlook.Calendar.IsInstanceNull) return;
                /* Not sure we want to connect here at all - just in the Instance method?
                 * if (!Calendar.Instance.Authenticator.Authenticated) 
                    Calendar.Instance.Authenticator.GetAuthenticated();*/
                
                //Retrieving calendars in Connect() is bad practice?
                //calendarFolders = CalendarFolders(); // Graph_GetCalendars(); // getCalendarStore(oNS);
                //calendarFolders = Ogcs.Outlook.Graph.Calendar.GetCalendars();
                ...
                Outlook.Calendar.Categories = new OutlookOgcs.Categories();
        ...
        public void Disconnect(Boolean onlyWhenNoGUI = false) {
            ///This isn't needed for Graph - no client or COM resources to dereference
        }

        public Boolean NoGUIexists() {
            log.Fine("Running against cloud O365.");
            return true;
        }
        ...
        public String CurrentUserSMTP() {
            return Settings.Instance.MSaccountEmail;
        }
        ...
        /*private Dictionary<String, Object> getCalendars() {
        ...
        /*private OutlookCalendarListEntry getCalendarStore(NameSpace oNS) {
            *//*MAPIFolder defaultCalendar = null;
            ...
            return null; // useOutlookCalendar;
        }*/
        ...
        public String GetRecipientEmail(Microsoft.Office.Interop.Outlook.Recipient recipient) {
            String retEmail = "";
        ...
        public global::Google.Apis.Calendar.v3.Data.Event IANAtimezone_set(global::Google.Apis.Calendar.v3.Data.Event ev, AppointmentItem ai) {
            ...
            if (!Sync.Engine.Calendar.Instance.Profile.OutlookGalBlocked && ai.Organizer != CurrentUserName()) {
                ...
                try {
                    ...
                    Forms.Main.Instance.Console.Update(Outlook.Calendar.GetEventSummary(ai) +
        ...
        public AppointmentItem WindowsTimeZone_set(AppointmentItem ai, global::Google.Apis.Calendar.v3.Data.Event ev, String attr = "Both", Boolean onlyTZattribute = false) {
        ...
        public void AddRtfBody(ref AppointmentItem ai, String RtfDocument) {
            if (Outlook.Factory.OutlookVersionName != Factory.OutlookVersionNames.Outlook2007) {
