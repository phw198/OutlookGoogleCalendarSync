...
## The policy
This privacy policy notice is served by Outlook Google Calendar Sync under the website; [{{ site.url }}]({{ site.url }}). The purpose of this policy is to explain to you how we control, process, handle and protect your personal information through the business, while you browse or use this website and/or the desktop application. If you do not agree to the following policy you may wish to cease viewing / using this website and associated application, and or refrain from submitting your personal data to us.

The policy is split into three areas:-
- [General Policy Terms](#general-policy-terms)
- [Website Privacy Policy](#website-privacy-policy)
- [Application Privacy Policy](#application-privacy-policy)
{: .indent-list}
...
**We process your information in the following ways:** Your Google account email address, as configured for use by OGCS, is (a) stored privately for internal records, (b) stored publically as an encrypted [MD5&nbsp;hash](https://en.wikipedia.org/wiki/MD5){: target="_blank"} for automatic verification by OGCS.  
**Data retention period:** We will continue to process your information under this basis until you withdraw consent or it is determined your consent no longer exists.  
**Sharing your information:** We do not share your information with any third parties.

## Your individual rights
You can read more about your GDPR rights in detail [here](ttps://ico.org.uk/for-organisations/data-protection-reform/overview-of-the-gdpr){: target="_blank"}. In summary, under the GDPR your rights are as follows:- 
...
You also have the right to complain to the [ICO](https://www.ico.org.uk){: target="_blank"} if you feel there is a problem with the way we are handling your data.
...
- [Overview of the GDPR - General Data Protection Regulation](https://ico.org.uk/for-organisations/data-protection-reform/overview-of-the-gdpr){: target="_blank"}  
- [Data Protection Act 2018](http://www.legislation.gov.uk/ukpga/2018/12/contents/enacted){: target="_blank"}  
- [Privacy and Electronic Communications Regulations 2003](http://www.legislation.gov.uk/uksi/2003/2426/contents/made){: target="_blank"}  
- [The Guide to the PECR 2003](https://ico.org.uk/for-organisations/guide-to-pecr/){: target="_blank"}

----

# Website Privacy Policy

Under the website [{{ site.url }}]({{ site.url }}), the following personal information may be processed.
...
Indirect use of cookies occur through the [placement of adverts](#sponsored-links-affiliate-tracking--commissions) and *Google Analytics* is deployed to provide anonymous basic usage statics which may store cookies to achieve this. Although not visible to us in Google Analytics reports, Google does capture user's IP addresses before aggregating them into geolocation reports. To protect your personal information [IP address anonymisation](https://support.google.com/analytics/answer/2763052?hl=en){: target="_blank"} has been configured before IP data is sent to Google. 
...
Configuration within OGCS also provides control over which calendar data is accessed and synchronised. As a minimum, date, time and subject/title of each in-scope calendar item is synchronised, yet even the words in the subject/title can be [obfuscated](/guide/syncoptions-how) for your individual privacy needs.

## Logging
OGCS logs its activity to a file on your computer. Daily log files are stored for a maximum of 30 days and can be manually deleted at any time. [Log verbosity](guide/appbehaviour#logging) is controlled from within the application, from `OFF` (none) through to `ULTRA-FINE` with `DEBUG` as the default.
...
## Error reporting
At your discretion, any errors generated by OGCS can be automatically submitted to me for analysis. This is achieved by sending the 50 lines of logging preceeding the error to [Google Cloud Logging](https://docs.cloud.google.com/logging/docs){: target="_blank"}. Reports are anonymised, though some logging lines may include personal information; users are informed of this before enabling automatic reporting and can opt-out at any time.

## Telemetry
Within OGCS, Google Analytics [Measurement Protocol](https://developers.google.com/analytics/devguides/collection/protocol/ga4){: target="_blank"} is used to help focus development of OGCS in areas that will benefit the most by understanding which versions of OGCS and Outlook are in use, number of syncs performed, feature utilisation and so forth. An option is available within OGCS to disable all telemetry.
