...
REM PM> packages\squirrel.windows.1.7.8\tools\Squirrel --releasify OutlookGoogleCalendarSync.2.7.5-alpha.nupkg --no-msi --loadingGif=..\docs\images\ogcs128x128-animated.gif
...
REM Build ZIP
cd OutlookGoogleCalendarSync\bin\Release
"c:\Program Files\7-Zip\7z.exe" u Portable_OGCS_v2.7.4.zip -u- -up0q0r2x2y2z1w2!Portable_OGCS_v2.7.5.zip *.dll *.ps1 ErrorReportingTemplate.json logger.xml tzdb.nzd OutlookGoogleCalendarSync.exe OutlookGoogleCalendarSync.exe.config Console\* 

"c:\Program Files\7-Zip\7z.exe" e Portable_OGCS_v2.7.4.zip Microsoft.Office.Interop.Outlook.DLL
"c:\Program Files\7-Zip\7z.exe" a Portable_OGCS_v2.7.5.zip Microsoft.Office.Interop.Outlook.DLL
