...
REM PM> packages\squirrel.windows.1.9.0\tools\Squirrel --releasify OutlookGoogleCalendarSync.2.8.4-alpha.nupkg --no-msi --loadingGif=..\docs\images\ogcs128x128-animated.gif
...
"c:\Program Files\7-Zip\7z.exe" e Portable_OGCS_v2.8.3.zip "Windows Defender SmartScreen Unblock.ps1"

"c:\Program Files\7-Zip\7z.exe" a Portable_OGCS_v2.8.4.zip Microsoft.Office.Interop.Outlook.DLL
"c:\Program Files\7-Zip\7z.exe" a Portable_OGCS_v2.8.4.zip stdole.dll
"c:\Program Files\7-Zip\7z.exe" a Portable_OGCS_v2.8.4.zip "Windows Defender SmartScreen Unblock.ps1"
