...
REM PM> packages\squirrel.windows.1.9.0\tools\Squirrel --releasify OutlookGoogleCalendarSync.2.10.3-alpha.nupkg --no-msi --loadingGif=..\docs\images\ogcs128x128-animated.gif
...
del Portable_OGCS_v2.10.3.zip
"c:\Program Files\7-Zip\7z.exe" u Portable_OGCS_v2.10.1.zip -u- -up0q0r2x2y2z1w2!Portable_OGCS_v2.10.3.zip *.dll *.ps1 ErrorReportingTemplate.json logger.xml tzdb.nzd OutlookGoogleCalendarSync.exe OutlookGoogleCalendarSync.exe.config OutlookGoogleCalendarSync.pdb Console\* 
...
"c:\Program Files\7-Zip\7z.exe" a Portable_OGCS_v2.10.3.zip Microsoft.Office.Interop.Outlook.DLL
"c:\Program Files\7-Zip\7z.exe" a Portable_OGCS_v2.10.3.zip stdole.dll
"c:\Program Files\7-Zip\7z.exe" a Portable_OGCS_v2.10.3.zip "Windows Defender SmartScreen Unblock.ps1"
