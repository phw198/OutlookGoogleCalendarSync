...
REM PM> packages\squirrel.windows.1.9.0\tools\Squirrel --releasify OutlookGoogleCalendarSync.3.0.2-alpha.nupkg --no-msi --loadingGif=..\docs\images\ogcs128x128-animated.gif
...
"c:\Program Files\7-Zip\7z.exe" a Portable_OGCS_v3.0.2.zip "Windows Defender SmartScreen Unblock.ps1"
