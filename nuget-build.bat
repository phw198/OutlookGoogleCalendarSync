...
REM PM> packages\squirrel.windows.1.7.8\tools\Squirrel --releasify OutlookGoogleCalendarSync.2.7.3-alpha.nupkg --no-msi --loadingGif=..\docs\images\ogcs128x128-animated.gif
