...
REM PM> packages\squirrel.windows.1.9.0\tools\Squirrel --releasify OutlookGoogleCalendarSync.3.0.3-alpha.nupkg --no-msi --loadingGif=..\docs\images\ogcs128x128-animated.gif
